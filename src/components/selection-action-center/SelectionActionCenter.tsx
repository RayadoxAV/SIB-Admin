...
const SelectionActionCenter: React.FC<SelectionActionCenterProps> = ({ className, selectionQuantity, handleClose }) => {
  ...
  return (
    <div className={`selection-action-center ${className}`} style={styleExpression} >
      ...
      <div className='actions'>
        {/* <button className='action'><i className='fa-solid fa-print'></i> Imprimir</button> */}
        <button className='action delete'><i className='fa-solid fa-trash'></i> Eliminar</button>
      </div>
    </div>
  );
};
