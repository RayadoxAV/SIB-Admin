      ...
      <div className='c-body'>
        <div style={{ display: 'flex', alignItems: 'flex-start' }}>
          ...
          <div className='actions-container'>
            <button ref={addInformationButton}  className='action fade-in-up'><i className='fa-solid fa-add'></i></button>
            <PopupMenu parent={addInformationButton} options={['1', '2']} actions={[() => {}, () => {}]} />
